...
namespace Farm_School
{
    public partial class SignupForm : Form
    {
        ...
        private void Signupbtn_Click(object sender, EventArgs e)
        {
            ...
            string confirmPassword = phntxt.Text;
        ...
        {
            string ConnectionString = "Data Source=VICTUS\\SQLEXPRESS;Initial Catalog=C#DB;Integrated Security=True;TrustServerCertificate=True";
            SqlConnection con = new SqlConnection(ConnectionString);
            con.Open();
            string FarmerId= Guid.NewGuid().ToString(); // Generate a new unique FarmerId
            string Name= fnametxt.Text.Trim();
            string Email = emailtxt.Text.Trim();
            String Phone = phntxt.Text.Trim();
            string Password = passtxt.Text.Trim();
            string Location = locationtxt.Text.Trim();
            
            string Query = "Insert into Farmers (FarmerId,Name,Email, Phone,Password, Location) values ('"+FarmerId+"','" +Name+ "','" + Email + "','" + Phone + "','" +Password + "','" + Location + "')";
